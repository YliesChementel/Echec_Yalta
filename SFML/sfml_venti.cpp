...
int main() {
    ...
    sf::ConvexShape losange = createLosange(center, mat5_1_start, mat5_6_start + 0.60f * (mat5_6_end - mat5_6_start), mat5_2_end, sf::Color::Black, sf::Color::Green);

    sf::ConvexShape losange17 = createLosange(center, mat6_1_start, mat6_6_start + 0.60f * (mat6_6_end - mat6_6_start), mat6_2_end, sf::Color::Black, sf::Color::Green);
    sf::ConvexShape losange18 = createLosange(center, mat4_1_start, mat4_6_start + 0.60f * (mat4_6_end - mat4_6_start), mat4_2_end, sf::Color::Black, sf::Color::Green);
    sf::ConvexShape losange19 = createLosange(center, mat3_1_start, mat3_6_start + 0.60f * (mat3_6_end - mat3_6_start), mat3_2_end, sf::Color::Black, sf::Color::Green);
    sf::ConvexShape losange20 = createLosange(center, mat2_1_start, mat2_6_start + 0.60f * (mat2_6_end - mat2_6_start), mat2_2_end, sf::Color::Black, sf::Color::Green);
    sf::ConvexShape losange21 = createLosange(center, mat1_1_start, mat1_6_start + 0.60f * (mat1_6_end - mat1_6_start), mat1_2_end, sf::Color::Black, sf::Color::Green);


    bool losangeFilled = false;
     sf::Clock clock;  
     bool showLosanges = true;
    while (window.isOpen()) {
        sf::Event event;
